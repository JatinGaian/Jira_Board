...
const SummaryDashBoard = () => {
    ...
    const {
        ...
        sprintBarChart, setFilterSprintBarChart, selected, setSelected, searchValue, setSearchValue, sprintPieChart, storyData,setStoryData
                        ...
                        <div className={css.sprintContainer}>
                            <div className={css.header}>
                                ...
                                <div className={css.status}>
                                    <input autoFocus type="text" placeholder='Search sprints....' onChange={(e) => setSearchValue(e.target.value)} value={searchValue} />
                    ...
                    <div className={css.mainRightContent}>
                        <div className={css.legend}>
                            <span>
                                ...
                                <p style={{ color: " #a8b5c6", backgroundColor: "#0f0f0f28" }}>Time Taken</p>
                            </span>
                            <span onClick={() => {
                                ...
                                <p style={{ color: `${selected.onTrack ? "#000000" : "#0dac0d"}`, backgroundColor: `${selected.onTrack ? "#0dac0d" : " #05c6051a"}` }}>On Track</p>
                            </span>
                            <span onClick={() => {
                                ...
                                <p style={{ color: `${selected.behind ? "#000000" : "#c9a927"}`, backgroundColor: `${selected.behind ? "#c9a927" : "#ffcc0018"}` }}>Slightly Behind</p>
                            </span>
                            <span onClick={() => {
                                ...
                                <p style={{ backgroundColor: "#c13131", boxShadow: "0px 0px 10px 1px #751313" }}></p>
                                <p style={{ color: `${selected.delayed ? "#000000" : "#d62424"}`, backgroundColor: `${selected.delayed ? "#d62424" : "#d6242420"}` }}>Delayed</p>
                            </span>
                            <div onClick={() => {
                                ...
                                <p style={{ color: `${selected.ahead ? "#000000" : "#bb86fc"}`, backgroundColor: `${selected.ahead ? "#bb86fc" : "#bb86fc1f"}` }}>
                                    Ahead
                                </p>
                            </div>
