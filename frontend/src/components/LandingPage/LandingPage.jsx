...
function LandingPage({ setBoardId, setView, setBoardName }) {
    ...
    const { allboards, token, allBoardLoading, is_summary, setIs_summary, setSelectedSprintFromSummary, setSelectedSprint, breadCrumbs, setBreadCrumbs } = useContext(SrdpContext)
    //#loading state 
