...
const SummaryPieCharts = ({ id, sprintData, color, subTaskData }) => {
  ...
  return (
    <div id={id} style={{ width: "100%", height: "100%", border: ".1rem solid  #bb86fc1f", borderRadius: ".4rem", backgroundColor:"#141313 " }}>
    </div>
  );
};
